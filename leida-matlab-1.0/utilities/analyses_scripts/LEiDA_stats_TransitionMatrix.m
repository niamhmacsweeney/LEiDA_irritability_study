...
%save transition matrix results:
if(pair)
    save([save_dir '/' save_file],'TM','TMnorm','TM_pval','TM_pval2sided','effectsize', ...
                              'cond','rangeK','file_V1','file_cluster','file_P','Index_Conditions', 'pair')
