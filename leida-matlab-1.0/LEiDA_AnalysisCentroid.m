...
Plot_C_boxplot_FO(leida_res,Vc_dir,SelectK,Centroid,Parcellation, index100areas);

% Plot boxplot of the dwell time values for the selected PL state
Plot_C_boxplot_DT(leida_res,Vc_dir,SelectK,Centroid,Parcellation, index100areas);

% Plot of summary information for the selected PL state
Plot_C_summary(leida_res,Vc_dir,SelectK,Centroid,Parcellation, index100areas);